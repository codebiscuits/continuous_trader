...
class Trader:
    ...
    def top_up_bnb(self, usdt_size: int) -> dict:
        ...
        # circuit-breaker in case of no funds
        if (bnb_value < 10) and (free_usdt < 10):
            return None
    ...
    def get_asset_bals(self) -> dict[str, dict[str, float]]:
        ...
        # dictionary comprehension to reorganise a list of dicts into a dict of dicts
        user_assets = {
            a['asset']: {
                'free': float(a['free']),
        ...
        # another dict comprehension to discard any entries with zero balance
        user_assets = {
...
class Coin:
    ...
    def update_ohlc(self, old_end):
        ...
        cols = {'timestamp': pl.Int64,
                ...
                'ignore': pl.String}
        data = pl.from_records(klines, schema=cols, orient="row")
